 ...
 * </ul>
 */
public class AisinoGestureDetector{
    /**
    ...
    public interface OnGestureListener {
        ...
        void onLongPress(MotionEvent e);
                 ...
                 * @param e The initial on down motion event that started the longpress.
                 */
        boolean onLongPressUp(MotionEvent e);
    ...
    private static final int LONGPRESS_TIMEOUT = 350;//ViewConfiguration.getLongPressTimeout();
    ...
    private static final String TAG = "AisinoGestrueDetecture";
     ...
     */
    public AisinoGestureDetector(Context context, OnGestureListener listener) {
     ...
     * @throws NullPointerException if {@code listener} is null.
     */
    public AisinoGestureDetector(Context context, OnGestureListener listener, Handler handler) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            if (mIsLongpressEnabled) {
                Log.d(TAG, "------->LONG_PRESS_TIME TAP_TIMEOUT="+TAP_TIMEOUT +" LONGPRESS_TIMEOUT="+LONGPRESS_TIMEOUT);
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            } else if ((Math.abs(scrollX) >= ScreenInfo.GESTURE_MIN_DIS) || (Math.abs(scrollY) >= ScreenInfo.GESTURE_MIN_DIS)) {
                handled = mListener.onScroll(mCurrentDownEvent, ev, scrollX, scrollY);
                mLastMotionX = x;
                mLastMotionY = y;
            }
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mIsDoubleTapping) {
                ...
                mHandler.removeMessages(TAP);
                mInLongPress = false;
                handled =  mListener.onLongPressUp(ev);
            } else if (mAlwaysInTapRegion) {
